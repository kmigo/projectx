...
class UolletiSnackbar extends StatelessWidget {
  ...
  const UolletiSnackbar.bottom({super.key,required this.backgroundColor ,this.padding , required this.title, this.trailling, this.leading}) : top = null, left = null, rigth = null, bottom = 0;
   ...
   UolletiSnackbar.bottomSuccess({super.key ,this.padding ,required String message}) : top = null, left = null, rigth = null, bottom = 0,backgroundColor=colorsDS.iconsPositive, title = UolletiText.contentLarge(message,color: colorsDS.textPure, bold: true),trailling= const SizedBox(),leading= const SizedBox();
  @override
