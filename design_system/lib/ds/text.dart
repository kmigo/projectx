...
class UolletiText extends StatelessWidget {
  ...
  const UolletiText.labelLarge(this.text,{super.key,this.color,bool? bold,this.priority = UolletiTextPriority.normal,this.textAlign, this.height}):size = (bold == true? 16 : 16),fontWeight = (bold == true? FontWeight.w500 : FontWeight.w300); 
  const UolletiText.labelXLarge(this.text,{super.key,this.color,bool? bold,this.priority = UolletiTextPriority.normal,this.textAlign, this.height}):size = (bold == true? 18 : 12),fontWeight = (bold == true? FontWeight.w500 : FontWeight.w300); 
