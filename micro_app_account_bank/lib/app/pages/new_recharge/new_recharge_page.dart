...
AccountBankReceiverEntity? get receiver {
  return _receiver != null? AccountBankReceiverDTO.fromMap(_receiver!.toMap()) : null;
}
AccountBankOriginEntity? get origin {
  return _origin != null? AccountBankOriginDTO.fromMap(_origin!.toMap()) : null;
}
            ...
            return BlocBuilder<GetCardBloc, GetCardState>(
              ...
              builder: (context, stateGetCard) {
                ...
                return FormField<NewRechargeSelect>(
                  key: formKey,
                  initialValue: NewRechargeSelect(stateGetCard.card?.originAccountEntity, stateGetCard.card?.receiverAccount),
                  builder: (stateForm) {
                              ...
                              child: Column(
                                children: [
                                  ...
                                  UolletiDropDown<AccountBankOriginEntity>(
                                      ...
                                      items: origins,
                                      validator: (e) =>  HelperInputValidator.required(e?.accountNumber),
                                      onChanged: (value){
                                        stateForm.didChange(stateForm.value?.copyWith(origin: value));
                                      },
                                      onChild: (value) =>
                                  ...
                                  UolletiDropDown<AccountBankReceiverEntity>(
                                      ...
                                      items: receivers,
                                      validator: (e) =>  HelperInputValidator.required(e?.tagName),
                                      onChanged: (value) {
                                         stateForm.didChange(stateForm.value?.copyWith(receiver: value));
                                      },
                                      onChild: (value) =>
